...
HEIGHT = 600
WIDTH = 800
TITLE = ("Healthy_Food_Game")

START_SPEED = 10

ITEMS = ["burger", "fries", "chipsimg", "soda", "milkshake"]
...
def draw():
    ...
    if game_over:
        display_message("GAME OVER", "You clicked junk food!")
    elif game_complete:
        display_message("YOU WON!", "You chose healthy food!")
    else:
        for item in items:
            item.draw()
